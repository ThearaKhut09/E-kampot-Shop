    ...
    <div x-data="{ showDeleteModal: false, deleteForm: null, itemName: '', itemType: '' }" x-show="showDeleteModal" x-cloak class="fixed inset-0 z-50 overflow-y-auto"
        ...
        <div class="flex items-center justify-center min-h-screen px-4 py-10 text-center sm:p-0">
            ...
            <div x-show="showDeleteModal" x-transition:enter="ease-out duration-300"
                ...
                <!-- Buttons -->
                <div class="mt-5 sm:mt-4 flex flex-col sm:flex-row justify-center gap-3 sm:gap-4">
                    <button @click="deleteForm.submit(); showDeleteModal = false" type="button"
                        class="w-full sm:w-auto inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-600 text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:text-sm transition-colors duration-200">
                        Delete
                    </button>
