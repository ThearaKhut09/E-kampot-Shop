        ...
        <form action="{{ route('admin.users.update', $user) }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <textarea id="address"
                          ...
                          rows="3"
                          class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                          placeholder="Enter user's full address...">{{ old('address', $user->address) }}</textarea>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="flex items-center">
                    <input type="checkbox"
                           ...
                           value="1"
                           class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="reset_password" class="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">
                        Send Password Reset
                    </label>
                </div>
            </div>
            ...
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                <h3 class="text-lg font-medium text-gray-800 dark:text-white mb-4">Change Password (Optional)</h3>
            ...
            <!-- User Statistics -->
            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                <h3 class="text-lg font-medium text-gray-800 dark:text-white mb-4">Account Statistics</h3>
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <p class="font-medium text-gray-900 dark:text-white">{{ $user->orders->count() ?? 0 }}</p>
                    </div>
                    <div>
                        <span class="text-sm text-gray-500 dark:text-gray-400">Total Spent</span>
                        <p class="font-medium text-gray-900 dark:text-white">
                            ${{ number_format($user->orders->where('status', 'completed')->sum('total_amount') ?? 0, 2) }}
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-yellow-800 dark:text-yellow-200">
                                <strong>Warning:</strong> You are editing an administrator account. Be careful when changing roles or deactivating the account.
                            </p>
                        </div>
                    </div>
                </div>
